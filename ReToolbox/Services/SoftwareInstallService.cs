    ...
    public class SoftwareInstallService
    {
        ...
        private List<SoftwareItem> GetDefaultSoftwareList()
        {
            return new List<SoftwareItem>
            {
                ...
                new() { Name = "Notepad++", WingetId = "Notepad++.Notepad++", Category = "开发工具", Description = "轻量代码与文本编辑器", IconGlyph = "\uE943" },
                new() { Name = "OBS Studio", WingetId = "OBSProject.OBSStudio", Category = "媒体", Description = "录屏与直播软件", IconGlyph = "\uEC4F" },
                new() { Name = "Discord", WingetId = "Discord.Discord", Category = "通讯", Description = "语音与文字聊天", IconGlyph = "\uE8BD" },
                new() { Name = "Spotify", WingetId = "Spotify.Spotify", Category = "媒体", Description = "音乐流媒体客户端", IconGlyph = "\uEC4F" },
                new() { Name = "ShareX", WingetId = "ShareX.ShareX", Category = "系统工具", Description = "截图与屏幕录制工具", IconGlyph = "\uE722" },
            };
        }
    }
}
